...
export const gameServerProducts: GameServerProduct[] = [
    ...
    plans: [
      {
        ...
        features: [
          ...
          { label: "RAM", value: "4GB" },
          { label: "Storage", value: "40GB NVMe" },
          { label: "Basic setup", value: true },
          { label: "Daily backups", value: true },
        ],
      },
      {
        ...
        features: [
          ...
          { label: "RAM", value: "8GB" },
          { label: "Storage", value: "80GB NVMe" },
          { label: "Full customization", value: true },
          { label: "Hourly backups", value: true },
        ],
      },
      {
        ...
        name: "Premium",
        whmcs_pid: 613,
        pricing: { monthly: 55.00, annually: 46.00 },
        features: [
      ...
      {
        id: "metin2-enterprise",
        name: "Enterprise",
        whmcs_pid: 614,
        pricing: { monthly: 95.00, annually: 80.00 },
        features: [
          { label: "Players", value: "1000+" },
          { label: "RAM", value: "32GB" },
          { label: "Storage", value: "300GB NVMe" },
          { label: "Dedicated resources", value: true },
          { label: "Custom configs", value: true },
        ],
      },
    ],
  },
    ...
    plans: [
      {
        ...
        name: "Public",
        whmcs_pid: 621,
        pricing: { monthly: 4.00, annually: 3.00 },
        features: [
          { label: "Slots", value: "16" },
          { label: "AMX Mod X", value: true },
          { label: "FastDL", value: true },
        ],
      },
      {
        ...
        features: [
          { label: "Slots", value: "24" },
          { label: "Custom mods", value: true },
          { label: "HLTV ready", value: true },
        ],
      },
      {
        id: "cs16-competitive",
        name: "Competitive",
        whmcs_pid: 623,
        pricing: { monthly: 9.00, annually: 7.50 },
        features: [
          { label: "Slots", value: "32" },
          { label: "Anti-cheat", value: true },
          { label: "Priority support", value: true },
        ],
      },
    ],
  ...
  {
    id: "farmingsim25-server",
    slug: "farming-simulator-25",
    gameSlug: "farmingsim25",
    name: "Farming Simulator 25 Server",
    category: "game-server",
    ...
    plans: [
      {
        ...
        features: [
          { label: "Players", value: "8" },
          { label: "RAM", value: "4GB" },
          { label: "Mods supported", value: true },
          { label: "Daily backups", value: true },
        ],
      },
      {
        id: "farmingsim25-ranch",
        name: "Ranch",
        popular: true,
        whmcs_pid: 632,
        pricing: { monthly: 18.00, annually: 15.00 },
    ...
    plans: [
      {
        ...
        features: [
          { label: "Players", value: "8" },
          { label: "RAM", value: "2GB" },
          { label: "Any world size", value: true },
          { label: "Daily backups", value: true },
        ],
      },
      {
        ...
        popular: true,
        whmcs_pid: 642,
        pricing: { monthly: 7.00, annually: 6.00 },
        features: [
          { label: "Players", value: "16" },
          { label: "RAM", value: "4GB" },
          { label: "tModLoader", value: true },
          { label: "Hourly backups", value: true },
        ],
      },
      {
    ...
    plans: [
      {
        ...
        features: [
          { label: "Slots", value: "16" },
          { label: "Rocket mods", value: true },
          { label: "Daily backups", value: true },
        ],
      },
      {
        id: "unturned-standard",
        name: "Standard",
        popular: true,
        whmcs_pid: 652,
        pricing: { monthly: 6.00, annually: 5.00 },
    ...
    plans: [
      ...
      },
      {
        ...
        features: [
          { label: "Players", value: "16" },
          { label: "RAM", value: "16GB" },
          { label: "Custom settings", value: true },
          { label: "Hourly backups", value: true },
        ],
      },
    ],
  ...
  {
    id: "ark-ascended-server",
    slug: "ark-ascended",
    gameSlug: "ark-ascended",
    ...
    plans: [
      ...
      {
        id: "ark-ascended-cluster",
        name: "Cluster",
        whmcs_pid: 674,
        pricing: { monthly: 180.00, annually: 150.00 },
        features: [
          { label: "Slots", value: "Unlimited" },
          { label: "RAM", value: "64GB+" },
          { label: "Full cluster", value: true },
          { label: "Dedicated resources", value: true },
        ],
      },
    ],
    ...
    plans: [
      {
        ...
        features: [
          ...
          { label: "Private lobby", value: true },
          { label: "Custom settings", value: true },
        ],
      },
      {
        ...
        popular: true,
        whmcs_pid: 682,
        pricing: { monthly: 5.00, annually: 4.00 },
        features: [
          { label: "Players", value: "30" },
          { label: "Multiple lobbies", value: true },
          { label: "Mod support", value: true },
        ],
      },
    ],
    ...
    plans: [
      ...
      },
      {
        ...
        features: [
          ...
          { label: "CPU", value: "4 vCores" },
          { label: "RAM", value: "8GB" },
          { label: "Full scripting", value: true },
        ],
      },
      {
        id: "ragemp-premium",
        name: "Premium",
        whmcs_pid: 693,
        pricing: { monthly: 80.00, annually: 67.00 },
        features: [
          { label: "Slots", value: "200" },
          { label: "CPU", value: "6 vCores" },
          { label: "RAM", value: "16GB" },
      ...
      {
        id: "ragemp-enterprise",
        name: "Enterprise",
        whmcs_pid: 694,
        pricing: { monthly: 150.00, annually: 125.00 },
        features: [
          { label: "Slots", value: "500" },
          { label: "CPU", value: "8 vCores" },
          { label: "RAM", value: "32GB" },
          { label: "Maximum resources", value: true },
        ],
      },
    ],
  },
  // SA-MP
  {
    ...
    plans: [
      ...
      },
      {
        ...
        popular: true,
        whmcs_pid: 702,
        pricing: { monthly: 14.00, annually: 11.00 },
        features: [
          { label: "Slots", value: "100" },
          { label: "MySQL included", value: true },
          { label: "Hourly backups", value: true },
        ],
      },
      {
  ...
  // MTA: San Andreas
  {
    ...
    plans: [
      ...
      },
      {
        ...
        name: "Premium",
        whmcs_pid: 713,
        pricing: { monthly: 32.00, annually: 27.00 },
        features: [
          { label: "Slots", value: "200" },
          { label: "Priority support", value: true },
          { label: "All features", value: true },
  ...
  // Day of Dragons
  {
    id: "dayofdragons-server",
    slug: "day-of-dragons",
    gameSlug: "dayofdragons",
    name: "Day of Dragons Server",
    category: "game-server",
