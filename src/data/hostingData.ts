...
export const vpsIntelPlans: Plan[] = [
  {
    id: "vps-intel-basic",
    name: "Intel Basic",
    description: "Intel Xeon entry-level",
    monthlyPrice: 12.99,
    yearlyPrice: 9.99,
    features: [
      { label: "CPU", value: "Intel Xeon E-2386G" },
  ...
  {
    id: "vps-intel-standard",
    name: "Intel Standard",
    description: "Balanced Intel performance",
    monthlyPrice: 24.99,
    yearlyPrice: 19.99,
    popular: true,
    features: [
  ...
  {
    id: "vps-intel-advanced",
    name: "Intel Advanced",
    description: "High-performance Intel",
    monthlyPrice: 49.99,
    yearlyPrice: 39.99,
    features: [
      { label: "CPU", value: "Intel Xeon Gold 6354" },
  ...
  {
    id: "vps-intel-enterprise",
    name: "Intel Enterprise",
    description: "Maximum Intel power",
    monthlyPrice: 89.99,
    yearlyPrice: 74.99,
    features: [
      { label: "CPU", value: "Intel Xeon Gold 6354" },
...
export const vpsAmdPlans: Plan[] = [
  {
    id: "vps-amd-basic",
    name: "AMD Basic",
    description: "AMD EPYC entry-level",
    monthlyPrice: 14.99,
    yearlyPrice: 11.99,
    features: [
  ...
  },
  {
    id: "vps-amd-standard",
    name: "AMD Standard",
    description: "Balanced AMD performance",
    monthlyPrice: 29.99,
    yearlyPrice: 23.99,
    popular: true,
    features: [
  ...
  },
  {
    id: "vps-amd-advanced",
    name: "AMD Advanced",
    description: "High-performance AMD",
    monthlyPrice: 54.99,
    yearlyPrice: 44.99,
    features: [
  ...
  {
    id: "vps-amd-enterprise",
    name: "AMD Enterprise",
    description: "Maximum AMD power",
    monthlyPrice: 99.99,
    yearlyPrice: 79.99,
    features: [
      { label: "CPU", value: "AMD EPYC 7543" },
...
// Legacy alias
export const vpsHostingPlans = vpsIntelPlans;
