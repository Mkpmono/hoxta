...
export const gameServers: GameServer[] = [
  ...
  },
  {
    ...
    slug: "garrys-mod",
    title: "Garry's Mod",
    coverImage: gameCoverImages["garrys-mod"],
  ...
  },
  {
    ...
    slug: "palworld",
    title: "Palworld",
    coverImage: gameCoverImages.palworld,
  ...
  },
  {
    ...
    slug: "7-days-to-die",
    title: "7 Days to Die",
    coverImage: gameCoverImages["7-days-to-die"],
  ...
  // ============================================
  {
    ...
    slug: "metin2",
    title: "Metin2",
    coverImage: gameCoverImages.metin2,
  ...
  },
  {
    ...
    coverImage: gameCoverImages.cs16,
  ...
  },
  {
    ...
    coverImage: gameCoverImages.farmingsim25,
  ...
  },
  {
    ...
    slug: "terraria",
    title: "Terraria",
    coverImage: gameCoverImages.terraria,
  ...
  },
  {
    ...
    slug: "unturned",
    title: "Unturned",
    coverImage: gameCoverImages.unturned,
  ...
  },
  {
    ...
    slug: "enshrouded",
    title: "Enshrouded",
    coverImage: gameCoverImages.enshrouded,
    pricingDisplay: "$0.80/slot",
    priceValue: 0.80,
    pricingUnit: "slot",
  ...
  },
  {
    ...
    coverImage: gameCoverImages.arkAscended,
    pricingDisplay: "$1.50/slot",
    priceValue: 1.50,
    pricingUnit: "slot",
  ...
  },
  {
    ...
    slug: "among-us",
    title: "Among Us",
    coverImage: gameCoverImages.amongus,
  ...
  },
  {
    ...
    slug: "ragemp",
    title: "RageMP",
    coverImage: gameCoverImages.ragemp,
  ...
  },
  {
    ...
    slug: "samp",
    title: "SA-MP",
    coverImage: gameCoverImages.samp,
    pricingDisplay: "$0.25/slot",
    priceValue: 0.25,
    pricingUnit: "slot",
  ...
  },
  {
    ...
    coverImage: gameCoverImages.mtasa,
    pricingDisplay: "$0.30/slot",
    priceValue: 0.30,
    pricingUnit: "slot",
  ...
  },
  {
    ...
    coverImage: gameCoverImages.dayofdragons,
    pricingDisplay: "$0.60/slot",
    priceValue: 0.60,
    pricingUnit: "slot",
  ...
  // ============================================
  {
    ...
    coverImage: gameCoverImages["counter-strike-source"],
    pricingDisplay: "$0.40/slot",
    priceValue: 0.40,
    pricingUnit: "slot",
  ...
  },
  {
    ...
    slug: "left-4-dead-2",
    title: "Left 4 Dead 2",
    coverImage: gameCoverImages["left-4-dead-2"],
    pricingDisplay: "$0.50/slot",
    priceValue: 0.50,
    pricingUnit: "slot",
  ...
  },
  {
    ...
    slug: "squad",
    title: "Squad",
    coverImage: gameCoverImages["squad"],
    pricingDisplay: "$1.20/slot",
    priceValue: 1.20,
    pricingUnit: "slot",
  ...
  },
  {
    ...
    coverImage: gameCoverImages["team-fortress-2"],
    pricingDisplay: "$0.35/slot",
    priceValue: 0.35,
    pricingUnit: "slot",
  ...
  },
  {
    ...
    slug: "beammp",
    title: "BeamMP",
    coverImage: gameCoverImages["beammp"],
    pricingDisplay: "$0.80/slot",
    priceValue: 0.80,
    pricingUnit: "slot",
  ...
  },
  {
    ...
    slug: "satisfactory",
    title: "Satisfactory",
    coverImage: gameCoverImages["satisfactory"],
    pricingDisplay: "$0.70/slot",
    priceValue: 0.70,
    pricingUnit: "slot",
  ...
  },
  {
    ...
    slug: "conan-exiles",
    title: "Conan Exiles",
    coverImage: gameCoverImages["conan-exiles"],
    pricingDisplay: "$0.90/slot",
    priceValue: 0.90,
    pricingUnit: "slot",
  ...
  },
  {
    ...
    coverImage: gameCoverImages["dont-starve-together"],
    pricingDisplay: "$0.40/slot",
    priceValue: 0.40,
    pricingUnit: "slot",
  ...
  },
  {
    ...
    slug: "humanitz",
    title: "HumanitZ",
    coverImage: gameCoverImages["humanitz"],
    pricingDisplay: "$0.60/slot",
    priceValue: 0.60,
    pricingUnit: "slot",
  ...
  },
  {
    ...
    slug: "icarus",
    title: "Icarus",
    coverImage: gameCoverImages["icarus"],
    pricingDisplay: "$0.70/slot",
    priceValue: 0.70,
    pricingUnit: "slot",
  ...
  },
  {
    ...
    slug: "scum",
    title: "SCUM",
    coverImage: gameCoverImages["scum"],
    pricingDisplay: "$0.80/slot",
    priceValue: 0.80,
    pricingUnit: "slot",
  ...
  },
  {
    ...
    coverImage: gameCoverImages["sons-of-the-forest"],
  ...
  },
  {
    ...
    slug: "the-forest",
    title: "The Forest",
    coverImage: gameCoverImages["the-forest"],
    pricingDisplay: "$0.50/slot",
    priceValue: 0.50,
    pricingUnit: "slot",
  ...
  },
  {
    ...
    slug: "v-rising",
    title: "V Rising",
    coverImage: gameCoverImages["v-rising"],
    pricingDisplay: "$0.70/slot",
    priceValue: 0.70,
    pricingUnit: "slot",
  ...
  },
  {
    ...
    coverImage: gameCoverImages["scp-secret-laboratory"],
    pricingDisplay: "$0.30/slot",
    priceValue: 0.30,
    pricingUnit: "slot",
  ...
  },
  {
    ...
    slug: "factorio",
    title: "Factorio",
    coverImage: gameCoverImages["factorio"],
    pricingDisplay: "$0.50/slot",
    priceValue: 0.50,
    pricingUnit: "slot",
  ...
  },
  {
    ...
    coverImage: gameCoverImages["euro-truck-simulator-2"],
    pricingDisplay: "$0.50/slot",
    priceValue: 0.50,
    pricingUnit: "slot",
  ...
  },
  {
    ...
    slug: "arma-reforger",
    title: "Arma Reforger",
    coverImage: gameCoverImages["arma-reforger"],
    pricingDisplay: "$1.00/slot",
    priceValue: 1.00,
    pricingUnit: "slot",
  ...
  },
  {
    ...
    slug: "subsistence",
    title: "Subsistence",
    coverImage: gameCoverImages["subsistence"],
    pricingDisplay: "$0.50/slot",
    priceValue: 0.50,
    pricingUnit: "slot",
  ...
  },
  {
    ...
    slug: "aska",
    title: "Aska",
    coverImage: gameCoverImages["aska"],
    pricingDisplay: "$0.60/slot",
    priceValue: 0.60,
    pricingUnit: "slot",
  ...
  },
  {
    ...
    slug: "hytale",
    title: "Hytale",
    coverImage: gameCoverImages["hytale"],
  ...
  },
  {
    ...
    slug: "veloren",
    title: "Veloren",
    coverImage: gameCoverImages["veloren"],
    pricingDisplay: "$0.30/slot",
    priceValue: 0.30,
    pricingUnit: "slot",
  ...
  },
  {
    ...
    slug: "urban-terror",
    title: "Urban Terror",
    coverImage: gameCoverImages["urban-terror"],
    pricingDisplay: "$0.20/slot",
    priceValue: 0.20,
    pricingUnit: "slot",
